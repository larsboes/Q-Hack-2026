#!/usr/bin/env python3
"""Read ambient light percentage from ADS1115 channel."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Read light from ADS1115")
    parser.add_argument("--channel", type=int, choices=(0, 1, 2, 3), default=3)
    ...
    try:
        _ = read_light_level(channel=args.channel, address=args.address)
    ...
    try:
        while True:
            values = read_light_level(channel=args.channel, address=args.address)
            print(
